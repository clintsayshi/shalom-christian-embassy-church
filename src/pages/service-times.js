    ...
    <Layout>
      ...
      <section>
        <div class="container mx-auto flex flex-col gap-2 sm:items-center">
          <h2 class="text-xl text-center">Sunday Main Service</h2>
          <p class="text-center">10:30 AM - 13:00 PM</p>
        </div>
      </section>

      <div class="container mx-auto h-px w-full my-8"></div>

      <section>
        <div class="container w-full mx-auto flex flex-col sm:flex-row gap-4 sm:gap-8 sm:items-center">
          <StaticImage
          ...
          <div class="flex flex-col flex-1 gap-4 items-center sm:items-start">
            <h2 class="text-xl text-center sm:text-left">Sunday Schools</h2>
            ...
            <div className="w-full flex flex-row justify-between">
              <h4 className="text-base font-medium">Pastor's Class</h4>
              <span className="text-sm text-gray-800">10:30 AM - 13:00 PM</span>
            </div>
          </div>
        </div>
      ...
      <div class="container mx-auto h-px w-full my-8 bg-gray-100 sm:bg-transparent"></div>

      <section>
        <div class="container mx-auto flex flex-col gap-4 sm:items-center">
          <h2 class="text-xl text-center">Weekday Services</h2>
